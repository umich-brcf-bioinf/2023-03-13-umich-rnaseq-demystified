...
**Checkpoint**: *If you generated and saved the `pca_plot` PCA plot, please indicate with the green 'check' button. Otherwise, please use the red 'x' button in your zoom reaction panel to have this step repeated.*


Since the `pca_plot` object is a `ggplot`--you can see this with `class(pca_plot)`--we can use what we learned at the end of the Computational Foundations Workshop to modify this plot as we might see necessary. **What are some modifications we might want to make?**



> # Independent Exercise - Customize a PCA {.unlisted .unnumbered}
>
