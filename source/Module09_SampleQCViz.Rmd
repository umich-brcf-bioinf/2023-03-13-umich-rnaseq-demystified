...
With this table of PCA statistics, we can use what we learned at the end of the Computational Foundations Workshop to customize plot as we might see necessary. **What are some modifications we might want to make?** [use slack poll to rank]:
