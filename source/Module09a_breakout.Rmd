...
```{r, eval= FALSE}
?labs
PCACustom2 + labs(title = "Iron Supplemented Mice", subtitle = "PCA of top 500 genes")
```
...
## Make our color palette more color-blind friendly (with `RColorBrewer`)
  ...
  * Pre-designed [color-blind friendly palettes available](http://www.cookbook-r.com/Graphs/Colors_(ggplot2)/#a-colorblind-friendly-palette)
